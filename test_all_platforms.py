#!/usr/bin/env python3
"""Test du scraper avec toutes les plateformes pour extraire minimum 50 produits."""
...
async def test_all_platforms():
    """Test le scraper avec toutes les plateformes pour obtenir 50+ produits."""
    
    # Configuration avec toutes les plateformes
    config = {
    ...
    print("=== Test du scraper avec toutes les plateformes ===")
    ...
    output_file = 'test_all_platforms_output.json'
